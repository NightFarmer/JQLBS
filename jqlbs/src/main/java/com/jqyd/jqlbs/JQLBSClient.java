...
//                    String url = "http://192.168.1.80:8080/jqgj_2.0_serv/login!lxsb_new.action";
    ...
    private static void location(final Context context, final LBSParam lbsParam, final LocationUpLoadCallBack callBack, final BDLocationListener locationListener) {
